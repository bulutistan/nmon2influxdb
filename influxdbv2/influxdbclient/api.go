...
import (
	"fmt"
	client "github.com/adejoux/nmon2influxdb/influxdbv2/influxdb1clientv2/v2"
	"log"
	"time"
)
...
func NewInfluxDB(cfg InfluxDBConfig) (db InfluxDB, err error) {
	...
	batchConfig := client.BatchPointsConfig{Precision: "s", Database: cfg.Database, Organization: cfg.Organization}
